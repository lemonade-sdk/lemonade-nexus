...
// The number of Win32 Window objects that currently exist.
...
// This API is only needed for per-monitor DPI awareness.
...
std::wstring WindowClassRegistrar::GetWindowClass() {
...
bool Win32Window::Create(const std::wstring& title,
  ...
  // Ensure the window class is registered before creating the window
