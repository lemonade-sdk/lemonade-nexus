...
struct AdversarialMesh : ::testing::Test {
    ...
    // Ages the epoch past its target and feeds every member a passing local
    // re-attestation, which is what lets the cadence prepare a transition.
    void prepare_handoff() {
